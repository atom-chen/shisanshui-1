...
public class DictInt2IntWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(System.Collections.Generic.Dictionary<int,int>), typeof(System.Object), "DictInt2Int");
		...
		L.RegFunction("New", _CreateDictInt2Int);
	...
	static int _CreateDictInt2Int(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				System.Collections.Generic.Dictionary<int,int> obj = new System.Collections.Generic.Dictionary<int,int>();
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(int)))
			{
				...
				System.Collections.Generic.Dictionary<int,int> obj = new System.Collections.Generic.Dictionary<int,int>(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(System.Collections.Generic.IDictionary<int,int>)))
			{
				System.Collections.Generic.IDictionary<int,int> arg0 = (System.Collections.Generic.IDictionary<int,int>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.IDictionary<int,int>));
				System.Collections.Generic.Dictionary<int,int> obj = new System.Collections.Generic.Dictionary<int,int>(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(System.Collections.Generic.IEqualityComparer<int>)))
			{
				...
				System.Collections.Generic.Dictionary<int,int> obj = new System.Collections.Generic.Dictionary<int,int>(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.Collections.Generic.IDictionary<int,int>), typeof(System.Collections.Generic.IEqualityComparer<int>)))
			{
				System.Collections.Generic.IDictionary<int,int> arg0 = (System.Collections.Generic.IDictionary<int,int>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.IDictionary<int,int>));
				System.Collections.Generic.IEqualityComparer<int> arg1 = (System.Collections.Generic.IEqualityComparer<int>)ToLua.CheckObject(L, 2, typeof(System.Collections.Generic.IEqualityComparer<int>));
				System.Collections.Generic.Dictionary<int,int> obj = new System.Collections.Generic.Dictionary<int,int>(arg0, arg1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: System.Collections.Generic.Dictionary<int,int>.New");
			}
		}
		catch(Exception e)
		{
	...
	static int _get_this(IntPtr L)
	{
		try
		{
			...
			System.Collections.Generic.Dictionary<int,int> obj = (System.Collections.Generic.Dictionary<int,int>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.Dictionary<int,int>));
	...
	static int GetEnumerator(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			System.Collections.Generic.Dictionary<int,int> obj = (System.Collections.Generic.Dictionary<int,int>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.Dictionary<int,int>));
			System.Collections.Generic.Dictionary<int,int>.Enumerator o = obj.GetEnumerator();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int get_Count(IntPtr L)
	{
		...
		try
		{
			...
			System.Collections.Generic.Dictionary<int,int> obj = (System.Collections.Generic.Dictionary<int,int>)o;
			int ret = obj.Count;
	...
	static int get_Keys(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			System.Collections.Generic.Dictionary<int,int> obj = (System.Collections.Generic.Dictionary<int,int>)o;
			System.Collections.Generic.Dictionary<int,int>.KeyCollection ret = obj.Keys;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_Values(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			System.Collections.Generic.Dictionary<int,int> obj = (System.Collections.Generic.Dictionary<int,int>)o;
			System.Collections.Generic.Dictionary<int,int>.ValueCollection ret = obj.Values;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
