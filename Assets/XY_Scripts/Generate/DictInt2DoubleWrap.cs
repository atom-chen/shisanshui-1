...
public class DictInt2DoubleWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(System.Collections.Generic.Dictionary<int,double>), typeof(System.Object), "DictInt2Double");
		...
		L.RegFunction("New", _CreateDictInt2Double);
	...
	static int _CreateDictInt2Double(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				System.Collections.Generic.Dictionary<int,double> obj = new System.Collections.Generic.Dictionary<int,double>();
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(int)))
			{
				...
				System.Collections.Generic.Dictionary<int,double> obj = new System.Collections.Generic.Dictionary<int,double>(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(System.Collections.Generic.IDictionary<int,double>)))
			{
				System.Collections.Generic.IDictionary<int,double> arg0 = (System.Collections.Generic.IDictionary<int,double>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.IDictionary<int,double>));
				System.Collections.Generic.Dictionary<int,double> obj = new System.Collections.Generic.Dictionary<int,double>(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(System.Collections.Generic.IEqualityComparer<int>)))
			{
				...
				System.Collections.Generic.Dictionary<int,double> obj = new System.Collections.Generic.Dictionary<int,double>(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(System.Collections.Generic.IDictionary<int,double>), typeof(System.Collections.Generic.IEqualityComparer<int>)))
			{
				System.Collections.Generic.IDictionary<int,double> arg0 = (System.Collections.Generic.IDictionary<int,double>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.IDictionary<int,double>));
				System.Collections.Generic.IEqualityComparer<int> arg1 = (System.Collections.Generic.IEqualityComparer<int>)ToLua.CheckObject(L, 2, typeof(System.Collections.Generic.IEqualityComparer<int>));
				System.Collections.Generic.Dictionary<int,double> obj = new System.Collections.Generic.Dictionary<int,double>(arg0, arg1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: System.Collections.Generic.Dictionary<int,double>.New");
			}
		}
		catch(Exception e)
		{
	...
	static int GetEnumerator(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			System.Collections.Generic.Dictionary<int,double> obj = (System.Collections.Generic.Dictionary<int,double>)ToLua.CheckObject(L, 1, typeof(System.Collections.Generic.Dictionary<int,double>));
			System.Collections.Generic.Dictionary<int,double>.Enumerator o = obj.GetEnumerator();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int get_Count(IntPtr L)
	{
		...
		try
		{
			...
			System.Collections.Generic.Dictionary<int,double> obj = (System.Collections.Generic.Dictionary<int,double>)o;
			int ret = obj.Count;
	...
	static int get_Keys(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			System.Collections.Generic.Dictionary<int,double> obj = (System.Collections.Generic.Dictionary<int,double>)o;
			System.Collections.Generic.Dictionary<int,double>.KeyCollection ret = obj.Keys;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_Values(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			System.Collections.Generic.Dictionary<int,double> obj = (System.Collections.Generic.Dictionary<int,double>)o;
			System.Collections.Generic.Dictionary<int,double>.ValueCollection ret = obj.Values;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
