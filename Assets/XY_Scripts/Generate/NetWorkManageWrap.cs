...
public class NetWorkManageWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("_serverUrl", get__serverUrl, set__serverUrl);
		L.RegVar("m_physicalAddress", get_m_physicalAddress, set_m_physicalAddress);
		L.RegVar("BaseUrl", get_BaseUrl, set_BaseUrl);
		L.RegVar("ServerUrl", get_ServerUrl, set_ServerUrl);
		L.RegVar("ServerUrlType", get_ServerUrlType, null);
	...
	static int HttpDownTextAsset(IntPtr L)
	{
		try
		{
			...
			NetWorkManage obj = (NetWorkManage)ToLua.CheckObject(L, 1, typeof(NetWorkManage));
			string arg0 = ToLua.CheckString(L, 2);
			System.Action<BestHTTP.HTTPRequestStates,string> arg1 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (System.Action<BestHTTP.HTTPRequestStates,string>)ToLua.CheckObject(L, 3, typeof(System.Action<BestHTTP.HTTPRequestStates,string>));
			}
			else
			{
				LuaFunction func = ToLua.ToLuaFunction(L, 3);
				arg1 = DelegateFactory.CreateDelegate(typeof(System.Action<BestHTTP.HTTPRequestStates,string>), func) as System.Action<BestHTTP.HTTPRequestStates,string>;
			}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get__serverUrl(IntPtr L)
	{
		try
		{
			ToLua.Push(L, NetWorkManage._serverUrl);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_ServerUrl(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			NetWorkManage obj = (NetWorkManage)o;
			ServerUrl ret = obj.ServerUrl;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index ServerUrl on a nil value" : e.Message);
		}
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_ServerUrlType(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			NetWorkManage obj = (NetWorkManage)o;
			int ret = obj.ServerUrlType;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index ServerUrlType on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_ServerUrl(IntPtr L)
	{
		object o = null;
