...
public class NGUITextWrap
{
	...
	static int GetExactCharacterIndex(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 3);
			BetterList<UnityEngine.Vector3> arg0 = (BetterList<UnityEngine.Vector3>)ToLua.CheckObject(L, 1, typeof(BetterList<UnityEngine.Vector3>));
			BetterList<int> arg1 = (BetterList<int>)ToLua.CheckObject(L, 2, typeof(BetterList<int>));
	...
	static int WrapText(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(LuaInterface.LuaOut<string>)))
			{
				string arg0 = ToLua.ToString(L, 1);
				string arg1 = null;
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(LuaInterface.LuaOut<string>), typeof(bool)))
			{
				string arg0 = ToLua.ToString(L, 1);
				string arg1 = null;
	...
	static int Print(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			BetterList<UnityEngine.Vector3> arg1 = (BetterList<UnityEngine.Vector3>)ToLua.CheckObject(L, 2, typeof(BetterList<UnityEngine.Vector3>));
			BetterList<UnityEngine.Vector2> arg2 = (BetterList<UnityEngine.Vector2>)ToLua.CheckObject(L, 3, typeof(BetterList<UnityEngine.Vector2>));
			BetterList<UnityEngine.Color32> arg3 = (BetterList<UnityEngine.Color32>)ToLua.CheckObject(L, 4, typeof(BetterList<UnityEngine.Color32>));
	...
	static int PrintApproximateCharacterPositions(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			BetterList<UnityEngine.Vector3> arg1 = (BetterList<UnityEngine.Vector3>)ToLua.CheckObject(L, 2, typeof(BetterList<UnityEngine.Vector3>));
			BetterList<int> arg2 = (BetterList<int>)ToLua.CheckObject(L, 3, typeof(BetterList<int>));
