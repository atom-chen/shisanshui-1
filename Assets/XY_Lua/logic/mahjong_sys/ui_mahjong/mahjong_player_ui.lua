...
--[[
		...
		this.logicSeat = room_usersdata_center.GetLogicSeatByViewSeat(this.seat)
	end
	...
	function this:ShowhuaEff()
		this:HideHuaEff()
		this.huaEff = animations_sys.PlayLoopAnimation(this.huaPoint, "anim_hua", "hua_1", 100, 100)
	end

	function this:HideHuaEff()
		if this.huaEff ~= nil then
			animations_sys.StopPlayAnimationToCache(this.huaEff, "anim_hua")
			this.huaEff = nil
		end
	end
	...
	function this.SetChatImg(content)
		...
		animations_sys.PlayAnimationByScreenPosition(this.chat_img.transform,0,0,"emoticon",chatImgAnimationTbl[content],80,80,false,function()
				--callback
				end)
	end
	...
	function this.ShowInteractinAnimation(viewSeat,content)
		if content == "1" then
			animations_sys.PlayAnimationByScreenPosition(this.transform,0,0,"chi_peng_gang_hu","chi1",100,100,false,function()
				--callback
				end)
		elseif content == "2" then
			animations_sys.PlayAnimationByScreenPosition(this.transform,0,0,"chi_peng_gang_hu","gang1",100,100,false,function()
					--callback
				end)
		elseif content =="3" then
			animations_sys.PlayAnimationByScreenPosition(this.transform,0,0,"chi_peng_gang_hu","hu1",100,100,false,function()
				--callback
				end)
		elseif content == "4" then
			animations_sys.PlayAnimationByScreenPosition(this.transform,0,0,"chi_peng_gang_hu","peng1",100,100,false,function()
				--callback
				end)
		elseif content == "5" then
			animations_sys.PlayAnimationByScreenPosition(this.transform,0,0,"chi_peng_gang_hu","zimo1",100,100,false,function()
				--callback
				end)
		end
