...
GStars_Normal_Cards = {
    ...
    0x22,0x23,0x24,0x25,0x26,0x27,0x28,0x29,0x2A,0x2B,0x2C,0x2D,0x2E,   --红桃 2 - A 	34 - 42
...
GStars_Special_Type_Name = {
    ...
    [GStars_Special_Type.PT_SP_FIVE_PAIR_AND_THREE] = "五对冲三",      --五队冲三 5对+3条
    ...
    [GStars_Special_Type.PT_SP_THREE_BOMB] = "三炸弹",              --三炸弹   3个铁枝
...
GStars_Ext_Score = {
    --前墩加成
    [1] = {
        [GStars_Normal_Type.PT_THREE] = 3,
    },
    --中墩加成
    [2] = {
        [GStars_Normal_Type.PT_FIVE] = 20,
        [GStars_Normal_Type.PT_STRAIGHT_FLUSH] = 10,
        [GStars_Normal_Type.PT_FOUR] = 8,
        [GStars_Normal_Type.PT_FULL_HOUSE] = 2,
    },
    --后墩加成
    [3] = {
...
function GetCardColor(nCard)
    return bit.band(nCard, MASK_COLOR)
end
--获取牌的点数
