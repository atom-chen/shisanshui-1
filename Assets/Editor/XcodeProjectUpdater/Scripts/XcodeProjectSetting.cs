...
public class XcodeProjectSetting : ScriptableObject {
    ...
    [System.Serializable]
    public struct URLIdentifierSet
    {
        public string Flags;
        public List<string> URLSchemeList;

        public URLIdentifierSet(string flags, List<string> targetPathList)
        {
            Flags = flags;
            URLSchemeList = targetPathList;
        }
    }
    public List<URLIdentifierSet> URLIdentifierList = new List<URLIdentifierSet>()
    {
